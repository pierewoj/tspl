...
In destruct we split the reasoning about a fact into few cases, each
is corresponding to different part of value's inductive definition 
(0, S n for natural numbers for example).

In induction we prove that fact is true for some base element (to be finished)
